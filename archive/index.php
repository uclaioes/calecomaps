...
<head>
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            MAP = L.mapbox.map('map', 'calecomaps.iggm72f9').setView([33.984, -118.093], 10).addControl(L.mapbox
            ...
            MAP.legendControl.addLegend(document.getElementById('legend-content').innerHTML).addLegend(document
        ...
        function drawVisualization(trif_id) {
            ...
            $.get("https://www.googleapis.com/fusiontables/v1/query", {
                sql: "SELECT * FROM " + TQRG + " WHERE TRIF_ID='" + trif_id + "'",
                key: apiKey
            }, function (response) {
        ...
        function drawVisualization2(trif_id) {
            $.get("https://www.googleapis.com/fusiontables/v1/query", {
                sql: "SELECT * FROM " + PWMP + " WHERE TRIF_ID='" + trif_id + "'",
                key: apiKey
            }, function (response) {
                var columns = response.columns;
        ...
        function drawVisualization3(trif_id) {
            $.get("https://www.googleapis.com/fusiontables/v1/query", {
                sql: "SELECT * FROM " + PIEC + " WHERE TRIF_ID='" + trif_id + "'",
                key: apiKey
            }, function (response) {
                var columns = response.columns;
                ...
                var options = {
                    title: '2012 ' + Name + ' Share (Pounds) of Total Toxic Releases in the ' + Industry +
        ...
        function drawVisualization4(trif_id) {
            $.get("https://www.googleapis.com/fusiontables/v1/query", {
                ...
                $('#CompanyName').html("<h2 id=\"Name\"><span class=\"subheading\">Facility Name:</span> " +
                    Name + "</h2>");
                $('#SCORE').html(
                ...
                $('#TypeIndustry').html(
                    "<h2 id=\"industry\"><span class=\"subheading\">Industry NAICS:</span> " + Industry +
                    "</h2>");
                $('#Note').html(
                ...
                var data = google.visualization.arrayToDataTable([
                    ...
                    ['Toxic Releases per $1000 of Revenue<a href="RPKR.php" target="_blank">[?]</a>',
                        Number(Revenue).toFixed(5) + ' pounds/$1000'
                    ],
                    ['Toxic Releases per $1000 of Revenue, Los Angeles Average', Number(RevenueAVG) +
                        ' pounds/$1000'
                    ],
                    [
                    ...
                    [
                        ...
                        Number(CANCER).toFixed(2) + ' cancers per million'
                    ],
...
<body>
    ...
    <div class="wrapper">
        ...
        <h3>Welcome!</h3> Cal EcoMaps is a tool to share and evaluate the environmental performance of Toxics Release Inventory
        (TRI) facilities in Los Angeles County through the
        <a href="eismethodology.php" target="_blank">Cal EcoMaps Environmental Impact Score</a>. Use the interactive map below to learn more about your facility or your
        neighborhood.
        <br>
        <br>
            ...
            <div class='my-legend'>
                ...
                <div class='legend-scale'>
                    <ul class='legend-labels'>
                        <li>
                            <span style='background:MediumBlue'></span>Primary Metals</li>
                        <li>
                            <span style='background:FireBrick;'></span>Petroleum</li>
                        <li>
                            <span style='background:Gold;'></span>Chemicals</li>
                        <li>
                            <span style='background:DarkGreen;'></span>Fabricated Metals</li>
                        <li>
                            <span style='background:#6c6c6c;'></span>Other Industries</li>
                    </ul>
                </div>
        ...
        <div id='legend-content2' style='display: none;'>
            <div class='my-legend2'>
                ...
                <div class='legend-scale'>
                    <ul class='legend-labels'>
                        <li>
                            <span style='background:#D8BFD8;'></span>low</li>
                        <li>
                            <span style='background:#4B0082;'></span>high</li>
                    </ul>
                </div>
