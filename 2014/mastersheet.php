  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <nav>
        ...
        <h2> Download all data for top 4 industries: </h2>
        <br>
        <br> Excel Sheet:
        <a href="downloads/mastersheet.xlsx" download>Download</a>
        <br>
        <br>
        <br>
        <br>

        <h2> Download all Environmental Impact Score data for top 4
          industries: </h2>
        <br>
        <br> Excel Sheet:
        <a href="downloads/eis.xlsx" download>Download</a>
        <br>
        <br>
