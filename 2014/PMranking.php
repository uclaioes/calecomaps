...
<html class="no-js" lang="en">
  ...
  <head>
    ...
    <title>Primary Metals Industry Ranking</title>
    ...
    <script type="text/javascript">
      function drawTTR() {
        ...
        tox.addColumn('number',
          'LA County Primary Metals Industry Average (lbs)');
        ...
        tox.addRows([
          ...
          ['HERAEUS PRECIOUS METALS NA LLC', 2853.47, 102411, 65454,
            238111
          ],
        ...
        var tac = new google.visualization.ComboChart(document.getElementById(
          'ToxicReleases'));
        tac.draw(tox, {
    ...
    <script type="text/javascript">
      function drawRev() {
        ...
        rev.addColumn('number',
          'LA County Primary Metals Industry Average (lbs/$1000)');
        rev.addColumn('number',
          'CA Primary Metals Industry Average (lbs/$1000)');
        rev.addRows([
        ...
        // Create and draw the visualization.
        var acr = new google.visualization.ComboChart(document.getElementById(
          'Revenue'));
        acr.draw(rev, {
    ...
    <script type="text/javascript">
      function drawTPounds() {
        ...
        toxp.addColumn('number',
          'LA County Primary Metals Industry Average (Toxicity x lbs) ');
        toxp.addColumn('number',
          'CA Primary Metals Industry Average (Toxicity x lbs)');
        toxp.addColumn('number',
          'US Primary Metals Industry Average (Toxicity x lbs)');
        toxp.addRows([
          ['CONSOLIDATED FOUNDRIES POMONA', 1548000000, 52228243, 27617641,
            584256245
          ],
          ['EXIDE TECHNOLOGIES', 14382926, 52228243, 27617641, 584256245],
          ['P KAY METAL INC', 801680, 52228243, 27617641, 584256245],
          ['HERAEUS PRECIOUS METALS NA LLC', 759408, 52228243, 27617641,
            584256245
          ],
          ['CERTIFIED ALLOY PRODUCTS INC', 565800, 52228243, 27617641,
            584256245
          ],
          ['MILLER CASTINGS INC', 565800, 52228243, 27617641, 584256245],
          ['LIGHT METALS INC', 295434, 52228243, 27617641, 584256245],
          ['PRECISION SPECIALTY METALS INC', 229613, 52228243, 27617641,
            584256245
          ],
        ...
        // Create and draw the visualization.
        var atox = new google.visualization.ComboChart(document.getElementById(
          'TPounds'));
        atox.draw(toxp, {
    ...
    <script type="text/javascript">
      function drawVisualization() {
        ...
        // Create and draw the visualization.
        var acp = new google.visualization.ComboChart(document.getElementById(
          'PWMA'));
        acp.draw(pwma, {
    ...
    <script type="text/javascript">
      function drawVisualization() {
        ...
        // Create and draw the visualization.
        var acl = new google.visualization.ComboChart(document.getElementById(
          'CancerRisk'));
        acl.draw(lcr, {
  ...
  <body>
    <div class="wrapper">
      ...
      <nav>
        ...
        <div align="center">
          <h2>Total Toxic Releases <a href="TOTALTOXICRELEASES.php "
              target="_blank">[?]</a></h2>
        </div>
        <div id="ToxicReleases"></div><br>
        <div align="center">
          <h2>Releases per $1000 Revenue <a href="RPKR.php"
              target="_blank">[?]</a></h2>
        </div>
        ...
        <div align="center">
          <h2>Percent of Preferred Waste Management Activities<a
              href="PPWMA.php" target="_blank">[?]</a></h2>
        </div>
        <div id="PWMA"></div><br>
        <div align="center">
          <h2>Regional Contribution to Lifetime Cancer Risk<a
              href="CancerMethod.php" target="_blank">[?]</a></h2>
        </div>
