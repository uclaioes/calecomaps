  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <nav>
        ...
        <h2>Facilities with higher scores have a greater impact on the
          environment and public health.
          <a href="eismethodology.php" target="_blank">The Cal EcoMaps
            Environmental Impact Score</a> was determined for facilities
          within their own industry. </h2>
        <br>
        <br> Download PDF:
        <a href="downloads/ranking/FMScores.pdf" download>Download</a>
        <br>
        <br>
        <iframe
          src="https://docs.google.com/spreadsheets/d/1ldDdzo58hCtl4MZsrHJneL5UGWNJOfJVmTRjpRsINwo/pubhtml?widget=true&amp;headers=false"
