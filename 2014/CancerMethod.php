...
<html class="no-js" lang="en">
  ...
  <head>
    ...
    <title>Regional Contribution to Lifetime Cancer Risk from Air Emissions
    </title>
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <nav>
        ...
        <h1>Regional Contribution to Lifetime Cancer Risk from Air Emissions
        </h1>
        <h2>Units: Number of cancers in one million people exposed in the L.A.
          Basin over 70 years of exposure due to toxic air emissions by a
          facility
        </h2> <br><br>
        Because Toxicity of Total Releases is unitless measure, we calculated
        the
        facility Regional Contribution to Lifetime Cancer Risk to provide a more
        concrete measure of health-related impacts. Air releases were only
        considered because inhalation rates could be determined by age and sex
        to
        calculate the number of cancers in one million people (Exposure Factors
        Handbook, US EPA). Results for this variable are screening-level
        estimates
        and suggest that a particular facility may contribute approximately some
        number of cancers in a million to the overall lifetime risk in the Los
        Angeles Basin. This estimate does not constitute a risk assessment and
        should not be used to draw conclusions about individual risk.
        <br><br>
        More information on this variable and how it was used to calculate the
        <a href="eismethodology.php" target="_blank">Cal EcoMaps Environmental
          Impact Score</a> can be found in our <a href="Report.php"
          target="_blank">report</a>.
        <br><br>
        Sources: <a
          href="https://www.epa.gov/oswer/riskassessment/sghandbook/riskcalcs.htm"
          target="_blank">EPA: Cancer Risk Calculations</a>, <a
          href="https://www2.epa.gov/toxics-release-inventory-tri-program/trinet"
          target="_blank">TRI.NET</a>, <a href="https://oehha.ca.gov/"
          target="_blank">Office of Environmental Health Hazards Assessment
          (OEHHA) </a>, <a
          href="https://cfpub.epa.gov/ncea/cfm/recordisplay.cfm?deid=20563"
          target="_blank">EPA: Exposure Factors Handbook (2011) </a>, <a
          href="http://sites.agu.org/" target="_blank"> American Geophysical
          Union</a>, <a href="https://www.census.gov/" target="_blank">US Census
          Bureau </a>
