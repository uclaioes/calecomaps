  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <nav>
        ...
        environmental impact indicators: <br><br><a
          href="TOTALTOXICRELEASES.php" target="_blank">1)the total amount of
          toxic releases</a> <br> <a href="RPKR.php" target="_blank">2)toxic
          releases per $1000 of
        ...
        <br><br>These five variables were chosen because they represent the
        impact
