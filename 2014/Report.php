  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <nav>
        ...
        This report contains analysis about the various data presented in
        this website. Download PDF:
        <a href="downloads/report.pdf">Download</a>
        <br>
        <br>
        <iframe
          src="https://docs.google.com/file/d/0B9mOxzKZCZz4MEhQZlZYVUkwRkU/preview"
